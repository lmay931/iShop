...
import shopping.list.ishop.databinding.FragmentTitleBinding
...
class TitleFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.createNewButton.setOnClickListener (
            Navigation.createNavigateOnClickListener(R.id.action_titleFragment_to_chooseNewNameFragment))
